...
#pragma mark UpdateEnergyLimit(UpdateEnergyLimitContract) returns (TransactionExtention)

/**
 * modify the energy_limit
 */
- (void)updateEnergyLimitWithRequest:(UpdateEnergyLimitContract *)request handler:(void(^)(TransactionExtention *_Nullable response, NSError *_Nullable error))handler{
  [[self RPCToUpdateEnergyLimitWithRequest:request handler:handler] start];
}
// Returns a not-yet-started RPC object.
/**
 * modify the energy_limit
 */
- (GRPCProtoCall *)RPCToUpdateEnergyLimitWithRequest:(UpdateEnergyLimitContract *)request handler:(void(^)(TransactionExtention *_Nullable response, NSError *_Nullable error))handler{
  return [self RPCToMethod:@"UpdateEnergyLimit"
            requestsWriter:[GRXWriter writerWithValue:request]
             responseClass:[TransactionExtention class]
        responsesWriteable:[GRXWriteable writeableWithSingleHandler:handler]];
}
